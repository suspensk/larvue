...
(function (root, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [!(function webpackMissingModule() { var e = new Error("Cannot find module \"buoy\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory(root)),
  ...
  var init = function init(root) {
    ...
    var hullabaloo = function hullabaloo() {
    ...
    hullabaloo.prototype.send = function (text, status) {
      ...
      if (typeof this.options.fnStart == "function") this.options.fnStart();
      ...
      if (typeof this.options.fnEnd == "function") this.options.fnEnd();
    };
    ...
    hullabaloo.prototype.closed = function (hullabaloo) {
      ...
      if (this.hullabaloos !== null) {
        ...
        if (idx !== -1) {
          ...
          if (typeof this.options.fnEndHide == "function") this.options.fnEndHide();
        }
      }
    };
    ...
    hullabaloo.prototype.animate = function (hullabaloo, move) {
      ...
      i,
          // Счетчик для перебора группы алертов
